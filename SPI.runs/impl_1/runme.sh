...
HD_PWD='D:/Hc tp v s nghip/Semicon/SPI/SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPIController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPIController.tcl -notrace
