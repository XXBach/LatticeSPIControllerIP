...
HD_PWD='D:/Hc tp v s nghip/Semicon/SPI/SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPIController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPIController.tcl
